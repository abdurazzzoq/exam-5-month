...
const Header = () => {
  ...
  return (
    <div className="">
      ...
      <div className="flex items-center lg:container mx-auto justify-between">
      ...
      <img
        ...
        <div className="flex items-center">
          <input
            ...
            className="py-1 px-3 outline-none w-64 lg:w-80 h-9 rounded"
          />
        </div>
        ...
        <div className=" flex justify-between gap-2">
          <div className="flex gap-2.5">
            ...
            <h4 className=" hidden lg:block  font-medium">Войти</h4>
          </div>

            <Link to={'/favourites'} element={<Favourites/>}>
...
<span className="bg-violet-500 text-white rounded-full px-1 absolute bottom-3 left-4 text-sm ">{favouriteList.length}</span>

            <h4 className=" hidden lg:block font-medium">Избранное</h4>
          </div>
            </Link>
          ...
          <div className="flex gap-2.5">
            ...
            <h4 className=" hidden lg:block font-medium">Корзина</h4>
          </div>
        </div>
      </div>

      {/* <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 left-10">
  <path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
</svg> */}

      <div className="flex justify-between mt-4 lg:container mx-auto text-gray-400">
        ...
        <Link to={"/HomeGoods"}>Home</Link>
        <Link to={"/Buildings"}>Buildings</Link>
        <Link to={"/AutoGoods"}>AutoGoods</Link>
        <Link to={"/ChildGoods"}>Child</Link> */}
      </div>
    </div>
  );
};
